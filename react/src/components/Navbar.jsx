...
const Navbar = ({openMenu}) => {
  ...
  return (
    <>
    <div className={`navbar ${openMenu ? 'opacity-100' : 'hidden max-md:opacity-0'} block transition duration-500 ease md:block bg-light-green transition-all duration-[1s] pt-16 pb-8 px-8 w-full min-w-full md:min-w-1/4 md:w-1/4 xxl:min-w-[15%] xxl:w-[15%] h-screen fixed group z-2 md:min-h-[49rem]`}>
