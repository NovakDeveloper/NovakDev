...
const PrevButton = ({ link, text }) => {
  ...
  return (
    <a 
      className="prev-button cursor-pointer flex flex-row-reverse gap-4 justify-end px-16 py-8 items-center w-full full text-2xl xxl:text-3xl text-dark-green mt-auto" 
      href={link}
    ...
    >
      ...
      <svg
        ...
        className="arrow-with-animation rotate-180 max-xxl:w-[28px] max-xxl:h-[28px]"
      >
