...
const Timelines = () => {
  return (
    ...
    <h2 className='text-h2-mobile md:text-h2 mb-4'><span className='text-dark-green'>H</span>istory</h2>                
        <p className='mb-4 text-x-large xxl:text-[1.5rem] leading-14'>Step into my journey through the realms of learning and work, where each experience has been <span className='text-dark-green font-medium'>a stepping stone towards excellence</span>.</p>
