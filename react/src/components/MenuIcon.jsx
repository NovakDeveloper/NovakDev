...
const MenuIcon = ({ handleMenu, openMenu }) => {
  return (
    <div onClick={handleMenu} className='cursor-pointer menu-icon min-w-[3.5rem] w-[3.5rem h-[3.5rem] fixed right-8 top-4 rounded-full border-2 border-dark-green bg-almost-white z-20 flex items-center justify-center group md:hidden'>
      {/* {openMenu ? (
