...
const Certifications = ({handleMenuIcon}) => {
  ...
  return (
    <>
      ...
      <p className='mb-4 text-x-large xxl:text-[1.5rem] leading-14'>Here, you can discover the three latest certifications I've attained on my professional journey.<br /> Click 'All Certifications' to explore my complete certification portfolio.</p>
