  ...
  return (
    <div className="group flex absolute bottom-6 right-6 gap-2">
      ...
      {skillList.map((skill, index) => (
        <p key={index} className="text-[0.75rem] bg-dark-green border-dark-green border text-white py-1 px-2 rounded-full group-hover:bg-almost-white group-hover:text-dark-green leading-1" style={{ zIndex: index }}>
